  ...
  const testimonials = [
    {
      ...
      company: 'TechCorp',
      content:
        'DEVPORTIX transformed how I showcase my work. The code syntax highlighting alone got me three interview calls!',
      avatar:
    ...
    },
    {
      ...
      company: 'StartupXYZ',
      content:
        'As someone with 50+ projects, organizing them was a nightmare. DEVPORTIX made it simple and beautiful.',
      avatar:
