          ...
          <div className="flex items-center">
            <Link to="/" className="flex items-center space-x-2" onClick={() => setIsOpen(false)}>
              <div className="flex flex-col justify-between items-center group cursor-pointer">
                <div>
                  <img src={logo} alt="DevPort Logo" className="w-20 h-10 lg:w-28 lg:h-16" />
                </div>
                <span className={`text-xs -mt-3.5 sm:text-sm group-hover:text-cyan-600 ${isDark ? 'text-white/90' : 'text-white/90'}`}>
